...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={cursorDot}
        className="custom-cursor custom-cursor-dot pointer-events-none fixed z-[10000] h-3 w-3 rounded-full bg-slate-900 shadow"
...
>
  ...
  <div className="pt-[100px] sm:mx-auto ">
    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 md:gap-12 px-4 sm:px-8">
      <div className="flex flex-col items-center md:items-start justify-center text-center md:text-left py-12 md:py-0">
        <div className="flex flex-col items-center justify-center">
        <h1 className="text-5xl sm:text-5xl md:text-[85px] text-[#a54657] audiowide font-bold leading-tight">Building What Matters.</h1>
        <h1 className="text-base sm:text-lg md:text-2xl mt-4"> COMPUTER SOCIETY OF INDIA STUDENT BRANCH, VIT PUNE</h1>
        </div>
      ...
      <div className="relative p-2 md:m-20 w-fit mt-6 md:mt-0">
        {/* hero illustration / collage */}
        <div className="aspect-[4/3] rounded-3xl border border-slate-200 bg-white/70 p-2 shadow-lg backdrop-blur anim-img max-w-full sm:max-w-md md:max-w-lg">
          <div
